...
{
    public class Repo<T> : IRepo<T>, IDisposable where T : class
    {
        ...
        public Repo(IUnitOfWork<TakeNotesDbContext> unitOfWork)
        ...
        public Repo(TakeNotesDbContext context)
        {
        ...
        public TakeNotesDbContext Context { get; set; }
        ...
        public virtual void Insert(T entity)
        {
            try
            {
                ...
                {
                    Context = new TakeNotesDbContext();
                }
